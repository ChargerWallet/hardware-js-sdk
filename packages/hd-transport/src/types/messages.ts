...
export type EthereumSignTypedDataCharger Wallet  = {
  address_n: number[];
  primary_type: string;
...
export type EthereumTypedDataStructRequestCharger Wallet  = {
  name: string;
};

export type EthereumStructMemberCharger Wallet  = {
  type: EthereumFieldTypeChargerWallet;
  name: string;
};

export type EthereumFieldTypeCharger Wallet  = {
...
export enum EthereumDataTypeCharger Wallet  {
  UINT = 1,
  INT = 2,
  BYTES = 3,
  STRING = 4,
...
export type EthereumTypedDataStructAckCharger Wallet  = {
  members: EthereumStructMemberChargerWallet[];
};

// EthereumTypedDataValueRequestChargerWallet
export type EthereumTypedDataValueRequestCharger Wallet  = {
  member_path: number[];
};

// EthereumTypedDataValueAckChargerWallet
export type EthereumTypedDataValueAckCharger Wallet  = {
  value: string;
};
...
export type EthereumGetPublicKeyCharger Wallet  = {
  address_n: number[];
  show_display?: boolean;
  chain_id?: number;
};
...
export type EthereumPublicKeyCharger Wallet  = {
  node: HDNodeType;
  xpub: string;
};

// EthereumGetAddressChargerWallet
export type EthereumGetAddressCharger Wallet  = {
  address_n: number[];
  show_display?: boolean;
  chain_id?: number;
};
...
export type EthereumAddressCharger Wallet  = {
  _old_address?: string;
  address?: string;
};

// EthereumSignTxChargerWallet
export type EthereumSignTxCharger Wallet  = {
  address_n: number[];
  nonce?: string;
  gas_price: string;
  gas_limit: string;
...
export type EthereumAccessListCharger Wallet  = {
  address: string;
  storage_keys: string[];
};

// EthereumSignTxEIP1559ChargerWallet
export type EthereumSignTxEIP1559Charger Wallet  = {
  address_n: number[];
  nonce: string;
  max_gas_fee: string;
...
export type EthereumTxRequestCharger Wallet  = {
  data_length?: number;
  signature_v?: number;
  signature_r?: string;
  signature_s?: string;
...
export type EthereumTxAckCharger Wallet  = {
  data_chunk: string;
};

// EthereumSignMessageChargerWallet
export type EthereumSignMessageCharger Wallet  = {
  address_n: number[];
  message: string;
  chain_id?: number;
};
...
export type EthereumMessageSignatureCharger Wallet  = {
  signature: string;
  address: string;
};

// EthereumVerifyMessageChargerWallet
export type EthereumVerifyMessageCharger Wallet  = {
  signature: string;
  message: string;
  address: string;
  chain_id?: number;
...
export type EthereumSignTypedHashCharger Wallet  = {
  address_n: number[];
...
export type EthereumTypedDataSignatureCharger Wallet  = {
  signature: string;
  address: string;
};
